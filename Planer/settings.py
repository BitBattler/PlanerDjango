...
ALLOWED_HOSTS = ['planer10-bgle67dp.b4a.run','node85a.containers.back4app.com', 'localhost', '127.0.0.1']
...
CSRF_TRUSTED_ORIGINS = ['http://127.0.0.1', 'http://localhost', 'http://node84a.containers.back4app.com', 'https://planer10-bgle67dp.b4a.run']

# CORS-Konfiguration: CORS_ALLOWED_ORIGINS
CORS_ALLOWED_ORIGINS = ['http://127.0.0.1', 'http://localhost', 'http://node84a.containers.back4app.com', 'https://planer10-bgle67dp.b4a.run']
